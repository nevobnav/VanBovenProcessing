# -*- coding: utf-8 -*-
"""
Created on Mon Jun  3 12:04:25 2019
...
#maak initiële waarden voor clustering
cover_lab = cv2.cvtColor(np.array([[[25,5,240]]]).astype(np.uint8), cv2.COLOR_BGR2LAB)
...
#                    b2[mask] = ma.masked
    ...
    cv2.imwrite(r'E:\400 Data analysis\410 Plant count\test_results\mask_'+template_name+'_full.png',template)     
